...
df_meas = pd.read_csv('data/measurement_14bus_train.csv', header=None)
cols = [6, 7, 20]
...
df_state = pd.read_csv('data/state_14bus_train.csv', header=None)
...
class Bus14:
    ...
    def estimated_np(self, state):
        ...
        # Q0, Q1 = self.line_matrix_converter_np(Q_lin
...
def train14(data, bus, file_name, params, num_epoch=100, batch_size=50, init=None):
...
# history = train14(data, bus, 'models/train_14', [64, 128], num_epoch=200, batch_size=BATCH_SIZE)
#
# with tf.Session() as sess:
#     model = Model14('models/train_14', sess)
